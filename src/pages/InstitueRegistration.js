          ...
          <div className="col-lg-7 left-side-pro d-flex flex-column justify-content-center align-items-center vh-100 vh-100-mobile my-5">
            <div className="card w-70 d-flex align-items-center justify-content-center form-container shadow p-4 mb-5 bg-white rounded">
              ...
              <form action="">
                ...
                <div className="name">
                  <fieldset className="p-2">Nom de l'institut *</fieldset>
                  <div className="d-flex ">
                    <input
                      type="text"
                      className="form-control mr-3 "
                      placeholder="Entrer le nom de l'institut.."
                    />
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-lg-6 col-md-12">
                    <fieldset className="p-2">Nom du responsable *</fieldset>
                    <input
                      type="text"
                ...
                <div className="row">
                  <div className="col-lg-6 col-md-12">
                    <fieldset className="p-2">Address *</fieldset>
                    <input
                      type="text"
                      className="form-control"
                      placeholder="Enter votre address.."
                    />
                  </div>
                  <Telephone />
                </div>
