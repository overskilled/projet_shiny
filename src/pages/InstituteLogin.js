...
const InstituteLogin = () => {
  ...
  return (
    <div className={styles.instituteLogin}>
      ...
      <b className={styles.librezVosJournesContainer}>
        <p
          className={styles.librezVosJournes}
        >{`Libérez vos journées et développez votre business `}</p>
        <p className={styles.librezVosJournes}>
          avec notre plateforme de réservation beauté.
        </p>
      </b>
      <b className={styles.vousEnAvezContainer}>
        <p className={styles.librezVosJournes}>Vous en</p>
        <p className={styles.librezVosJournes}>avez rêvé.</p>
      </b>
      ...
      <b className={styles.contactshinycom}>contact@shiny.com</b>
      <b className={styles.b}>(+237) 600000000</b>
      <img className={styles.vectorIcon} alt="" src="/vector.svg" />
      <div className={styles.rectangleParent}>
        <div className={styles.groupChild} />
        <div className={styles.nomDeLinstitut}>Nom de l’institut *</div>
        <div className={styles.groupItem} />
        <div className={styles.entrerLeNom}>Entrer le nom de l’institut..</div>
        <div className={styles.vousTesGrantContainer}>
          <p className={styles.librezVosJournes}>
            Vous êtes gérant d’un établissement beauté ?
          </p>
          <p className={styles.librezVosJournes}>
        ...
        <div className={styles.nomDuResponsable}>Nom du responsable *</div>
